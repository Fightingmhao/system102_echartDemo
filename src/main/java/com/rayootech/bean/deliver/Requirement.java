...
public class Requirement implements Serializable {
    ...
    public Integer getReqPubState() {
        return reqPubState;
    }

    public void setReqPubState(Integer reqPubState) {
        this.reqPubState = reqPubState;
    }
